...
class AddItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapterUnidade = ArrayAdapter(this, R.layout.simple_spinner_item, options)
        adapterUnidade.setDropDownViewResource(R.layout.simple_spinner_dropdown_item)
        ...
        adapterCategoria.setDropDownViewResource(R.layout.simple_spinner_dropdown_item)
